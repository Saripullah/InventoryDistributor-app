...
class Laporan extends CI_Controller
{
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $pdf->Cell(190, 7, 'CV. VICTORY ABADI ', 0, 1, 'C');
        $pdf->SetFont('Times','',   10);
        $pdf->Cell(190, 4, 'JL. Kalikasa KM.15 GG Damang Ari Luhing RT 18 RW 04 ', 0, 1, 'C');
        $pdf->SetFont('Times','',   10);
        $pdf->Cell(190, 4, 'Desa Parenggean Kotawaringin Timur Kab. Kotawaringin Timur ', 0, 1, 'C');
        $pdf->SetFont('Times', 'B', 16);
        $pdf->Cell(190, 12, 'Laporan ' . $table, 0, 1, 'C');
        $pdf->SetFont('Times', '', 10);
        ...
        if ($table_ == 'barang_masuk') :
            ...
            $pdf->Cell(40, 7, 'Keterlambatan Input', 1, 0, 'C');
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(40, 7, $d['tanggal_sekarang'], 1, 0, 'C');
