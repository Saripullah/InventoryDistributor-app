...
class Supplier extends CI_Controller
{
    ...
    public function delete($getId)
    {
        ...
        $isSupplierReferenced = $this->admin->checkReferencedData('barang_masuk', 'supplier_id', $id);
        if ($isSupplierReferenced) {
            set_pesan('Gagal dihapus karena data masih terkait');
        } else {
