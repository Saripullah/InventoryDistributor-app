<div class="row justify-content-center">
	<div class="col-md-8">
		<div class="card shadow-sm border-bottom-primary">
			...
			<div class="card-body">
				<?= form_open('requestbarang/input'); ?>
				<input type="hidden" name="user_id" value="<?= $this->session->userdata('login_session')['user'] ?>">
				<input type="hidden" name="isPermit" value="0">
					...
					<div class="col-md-9">
						<div class="input-group">
							...
							<select class="form-control single-select" id="supplier_id" name="supplier_id">
								...
								<option value="<?php echo $s['id_supplier']; ?>"><?php echo $s['nama_supplier']; ?>
								</option>
								<?php endforeach; ?>
							</select>
						</div>
					...
					<div class="col-md-9">
						<div class="input-group">
							...
							<select class="form-control single-select" id="satuan_id" name="satuan_id">
								...
								<option value="<?php echo $n['id_satuan']; ?>"><?php echo $n['nama_satuan']; ?>
								</option>
								<?php endforeach; ?>
							</select>
						</div>
