		...
		<div class="card shadow-sm border-bottom-primary">
			<div class="card-header bg-white py-3">
				<div class="row">
					...
					<div class="col-auto">
						<?php if (is_admin()) : ?>
						<a href="<?= base_url('requestbarang/index_admin') ?>"
			...
			<div class="card-body">
				...
				<div class="row form-group">
					<label class="col-md-3 text-md-right" for="nama_supplier">Pilih Akun</label>
					<div class="col-md-9">
						<div class="input-group">
							...
							<select class="form-control single-select" id="user_id" name="user_id">
								<option value="">-- Pilih --</option>
								<!-- Buat pilihan dropdown berasal dari database -->
								<?php foreach($user as $u): ?>
								<option value="<?= $u['id_user'] ?>"
									<?= ($u['id_user'] == $datas[0]->user_id) ? 'selected' : '' ?>>
									<?= $u['nama'] ?>
								</option>
								<?php endforeach; ?>
							</select>
