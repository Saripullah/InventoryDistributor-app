...
">
					...
					<th>
						<a href="#" data-toggle="modal" data-target="#statusModal<?= $s->id ?>"
							class="btn btn-circle btn-secondary btn-sm">
							<i class="fa fa-cog"></i>
						</a>
						<a href="<?= base_url('requestbarang/show_admin/') . $s->id ?>"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<?= form_open('requestbarang/toggle'); ?>
										<?= form_hidden(
										...
										<div class="row form-group">
											<label class="col-md-3 text-md-right" for="nama_supplier">Pilih
												Status</label>
											<div class="col-md-9">
												<div class="input-group">
													...
													<select class="form-control" id="isPermit" name="isPermit">
														...
														<option value="3">Menunggu Dikirim</option>
														<option value="4">Dikirim</option>
														<option value="5">Diterima</option>
														<option value="6">Stok habis</option>
													</select>
												</div>
											</div>
										</div>
