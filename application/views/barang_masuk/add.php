        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= $this->uri->segment(3) == '' ? $id_barang_masuk : $barang_masuk->id_barang_masuk; ?>" type="text" readonly="readonly" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= $this->uri->segment(3) == '' ? set_value('tanggal_masuk', date('Y-m-d')) : $barang_masuk->tanggal_masuk; ?>" name="tanggal_masuk" id="tanggal_masuk" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                        ...
                        <div class="input-group">
                            <select name="supplier_id" id="supplier_id" class="custom-select">
                                ...
                                <?php foreach ($supplier as $s) : ?>
                                    <!-- <option <?= set_select('supplier_id', $s['id_supplier']) ?> value="<?= $s['id_supplier'] ?>" <?= $s['id_supplier'] == $barang_masuk->supplier_id ? 'selected' : ''?>><?= $s['nama_supplier'] ?></option> -->
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <!-- <option <?= $this->uri->segment(3) == $b['id_barang'] ? 'selected' : '';  ?> <?= set_select('barang_id', $b['id_barang']) ?> value="<?= $b['id_barang'] ?>"<?= $b['id_barang'] == $barang_masuk->barang_id ? 'selected' : ''?>><?= $b['id_barang'] . ' | ' . $b['nama_barang'] ?></option> -->
                                    <?php if ($this->uri->segment(3) == '') { ?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= $this->uri->segment(3) == '' ? set_value('jumlah_masuk') : $barang_masuk->jumlah_masuk; ?>" name="jumlah_masuk" id="jumlah_masuk" type="number" class="form-control" placeholder="Jumlah Masuk...">
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="expired">Expired</label>
                    <div class="col-md-4">
                        <input value="<?= set_value('expired', date('Y-m-d')); ?>" name="expired" id="expired" type="text" class="form-control date2" placeholder="Expired...">
