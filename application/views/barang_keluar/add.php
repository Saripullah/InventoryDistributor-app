	...
	<div class="col-md-8">
		<div class="card shadow-sm border-bottom-primary">
			...
			<div class="card-body">
				...
				<?= form_open('', [], ['id_barang_keluar' => $id_barang_keluar, 'user_id' => $this->session->userdata('login_session')['user'], 'tanggal_keluar' => '']); ?>
				...
				<div class="row form-group">
					<label class="col-md-4 text-md-right" for="tanggal_sekarang">Keterlambatan Input</label>
					<div class="col-md-4">
						<input value="<?= set_value('tanggal_sekarang', date('Y-m-d')); ?>" name="tanggal_sekarang" id="tanggal_sekarang" type="text" class="form-control date" placeholder="Tanggal Sekarang...">
						<?= form_error('tanggal_sekarang', '<small class="text-danger">', '</small>'); ?>
					</div>
				</div>
				<div class="row form-group">
					<label class="col-md-4 text-md-right" for="tanggal_keluar">Tanggal Keluar</label>
					<div class="col-md-4">
						<input value="<?= set_value('tanggal_keluar', date('Y-m-d')); ?>" name="tanggal_keluar" id="tanggal_keluar" type="text" class="form-control " placeholder="Tanggal Masuk..." readonly>
				...
				<div class="row form-group">
					<input readonly="readonly" id="id_barang_masuk" type="hidden" name="id_barang_masuk" class="form-control">
