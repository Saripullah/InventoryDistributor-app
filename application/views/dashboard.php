...
<div class="row">
	...
	<div class="alert alert-warning alert-dismissible fade show" role="alert">
		<strong>Pemberitahuan</strong> Stok barang <?php echo $data->nama_barang; ?> kritis
		 segera lakukan order kembali !
	...
	<div class="col-lg-6">
			<?php foreach($cekrequest as $data){ ?>
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>Pemberitahuan</strong> Request barang untuk <?php echo $data->nama_barang; ?> Segera lakukan Update !
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="col-md-4">
		<div class="card shadow mb-4">
			<div class="card-header bg-warning py-3">
				<h6 class="m-0 font-weight-bold text-white text-center">Stok Barang Kritis</h6>
			</div>
